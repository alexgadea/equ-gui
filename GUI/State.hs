...
module GUI.State ( -- * Proyeccion de componentes del estado
                       module GUI.State.Expr
                     , module GUI.State.Proof
                     , module GUI.State.Undo
                     , getSymFrame
                     , getParentNamed
                     , getWindow
                     , getAxiomFrame
                     ...
                     , module GUI.State.TypeTree
                     -- * Funciones relacionadas con pruebas
                     , updateProofState 
                     , unsetExprState
                     , unsetProofState
                     , changeProofFocus
                     , module GUI.State.Internal
                     -- * Manipulación del contexto global
                     , module GUI.State.Ctx
                     )
    where

import GUI.State.Internal
import GUI.State.Expr
import GUI.State.Proof hiding (validateStep)
import qualified GUI.State.Proof as Proof
import GUI.State.Ctx
import GUI.State.SymbolList
import GUI.State.Undo
import GUI.State.TypeTree
import GUI.State.Exercise(getExerciseConfTypeCheck)
import GUI.Types
import GUI.Utils
import GUI.Settings
